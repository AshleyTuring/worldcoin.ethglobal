...
namespace Auth0
{
    ...
    public class DeviceFlow : MonoBehaviour
    {
        ...
        /// </summary>
        public TMP_Text VerificationUri;
        
        /// <summary>
        /// <see cref="Text"/> to set the user code returned by Auth0 (****-****).
        /// </summary>
        public TMP_Text UserCode;
        ...
        private void Awake()
        {
            ...
            {
                this.VerificationUri = GameObject.Find("VerificationUri").GetComponent<TMP_Text>();
            }

            if (this.UserCode == null)
            {
                this.UserCode = GameObject.Find("UserCode").GetComponent<TMP_Text>();
            }
        ...
        public void OpenURL()
        {
            Application.OpenURL(VerificationUri.text);
        }

        public void CopyCode()
        {
            GUIUtility.systemCopyBuffer = UserCode.text;
            StartCoroutine(InformOfCopy());
        }

        IEnumerator InformOfCopy()
        {
            string originalText = UserCode.text;
            UserCode.text = "Copied!";
            yield return new WaitForSeconds(2);
            UserCode.text = originalText;
        }
    }
}
